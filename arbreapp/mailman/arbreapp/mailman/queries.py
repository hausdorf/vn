...
EMAIL_COLL = 'emails'
COMMUNICATIONS_COLL = 'communications'
...
def insert_communication_edges(db, edge_list):
    ...
    if(num_edges > 0):
        while num_edges > 0:
            ...
            db[COMMUNICATIONS_COLL].insert(edge_page)
            edge_list = edge_list[200:]
            num_edges = len(edge_list)

    apply_all_indexes(db, COMMUNICATIONS_COLL)
